...
import com.expressProjectUtils.MailUtils;
...
public class CustomerAction extends ActionSupport implements ModelDriven<Customer>{
    ...
    public String regist() {
        ...
        if(StringUtils.isNotEmpty(checkcode)&&StringUtils.isNotEmpty(serverCode)&&serverCode.equals(checkcode)){
            ...
            String emailBody = "感谢您注册本网站的帐号，请在24小时之内点击<a href='http://localhost:8089/portal/customerAction_active.action?activeCode="
    ...
    public String active() {
        ...
        if(StringUtils.isNotEmpty(serverCode)
            ...
            //判断用户是否已激活
            //激活
            WebClient.create("http://localhost:8088/crm/webService/customerService/active")
            .type(MediaType.APPLICATION_JSON)
    ...
    public String login() {
        ...
        if(StringUtils.isNotEmpty(serverCode)
            ...
            Customer customer = WebClient.create(
                    "http://localhost:8088/crm/webService/customerService/isActived")
                    .type(MediaType.APPLICATION_JSON)
                    .query("telephone", model.getTelephone())
            ...
            if (customer != null && customer.getType() != null) {
                if(customer.getType() == 1){
                    ...
                    Customer c = WebClient.create(
                            "http://localhost:8088/crm/webService/customerService/login")
                            .type(MediaType.APPLICATION_JSON)
                            .query("telephone", model.getTelephone())
